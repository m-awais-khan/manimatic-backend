...
class VideoEditorProject(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='video_editor_projects')
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name='video_editor_projects', null=True, blank=True)
    title = models.CharField(max_length=255, default='Untitled Edit')
